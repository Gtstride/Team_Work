...
class ArticleController {
  static async createArticle(req, res) {
    try {
      ...
      const create = `INSERT INTO articles( title, article, created_on
  ...
  static async modifyArticle(req, res) {
    try {
      ...
      const modify = 'UPDATE articles SET title=$1, article=$2, created_on=$3 WHERE article_id=$4 RETURNING *';
      // console.log(modify);
  ...
  static async deleteArticle(req, res) {
    try {
      ...
      const removeArticle = 'DELETE FROM articles WHERE article_id = $1';
      const value = [id];
